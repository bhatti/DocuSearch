...
public class RegionLookupTest {
    ...
    public final void testGetContinentNameByCode() {
        Assert
                .assertEquals("Africa", regionLookup
                        .getContinentNameByCode("AF"));
        Assert
                .assertEquals("Europe", regionLookup
                        .getContinentNameByCode("EU"));
    }
    ...
    public final void testGetCountryCodesByContinentCode() {
        Assert.assertTrue(regionLookup.getCountryCodesByContinentCode("OC")
                .contains("AU"));
