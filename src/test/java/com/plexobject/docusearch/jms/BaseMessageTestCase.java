...
public abstract class BaseMessageTestCase {
    ...
    protected static final Logger LOGGER = Logger
            .getLogger(DeadLetterReprocessorTest.class);
    private static final long QUEUE_MEMORY_LIMIT = 2097152;

    protected static final String DEFAULT_BROKER = "test_broker";
    static {
        System.getProperties().setProperty("com.sun.management.jmxremote.port",
                "1099");
        System.getProperties().setProperty(
                "com.sun.management.jmxremote.authenticate", "false");
        System.getProperties().setProperty("com.sun.management.jmxremote.ssl",
                "false");
    }
    ...
    private BrokerService createBroker() throws Exception {
        ...
        policy
                .setPendingQueuePolicy(new StorePendingQueueMessageStoragePolicy());
        DeadLetterStrategy defaultDeadLetterStrategy = policy
        ...
        managementContext.setCreateConnector(true); // starts JMX server
    ...
    private ConnectionFactory createConnectionFactory() throws Exception {
        final ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory(
                CONNECTOR_URL); // "vm://localhost?broker.persistent=false"
        ...
        int rollbackCount = connection.getRedeliveryPolicy()
                .getMaximumRedeliveries() + 1;
