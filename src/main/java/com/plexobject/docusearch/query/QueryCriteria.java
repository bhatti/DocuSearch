...
public class QueryCriteria {
	...
	public String[] getFields() {
		String value = options.get(FIELDS);
		return value != null ? value.split(",") : new String[0];
	}

	public boolean hasFields() {
		return options.get(FIELDS) != null;
	}

	public QueryCriteria addField(final String field) {
		String value = options.get(FIELDS);
		if (value != null) {
			value = value + "," + field;
		} else {
		...
		options.put(FIELDS, value);
		return this;
	}

	public QueryCriteria addFields(final String... fields) {
		return addFields(Arrays.asList(fields));
	}

	public QueryCriteria addFields(Collection<String> fields) {
